...
$(function(){   
   ...
   $menuArr.click(function(){      
     ...
     case '${pageContext.request.contextPath}/productlist':
    	loadMenu(url, load);
     	break;
     case '${pageContext.request.contextPath}/cartlistresult.jsp':
     	loadMenu(url, load);
      	break;
...
<ul>
  ...
  <li><a href="${pageContext.request.contextPath}/orderlist">주문목록</a>
  </c:otherwise>
  </c:choose>
  <li><a href='${pageContext.request.contextPath}/productlist'>상품목록</a>
  <li><a href='${pageContext.request.contextPath}/jq/display.html'>display.html</a></li>      
  <li><a href='${pageContext.request.contextPath}/cartlistresult.jsp'>장바구니</a>
</ul>
